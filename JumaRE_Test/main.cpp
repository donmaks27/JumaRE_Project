...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Window: ") + apiName, { 800, 600 } } }
        }))
    {
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Position2D to Color: ") + apiName, { 800, 600 } } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("TextureCoords to Color: ") + apiName, { 800, 600 } } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Texture: ") + apiName, { 800, 600 } } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Render Target: ") + apiName, { 800, 600 } } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Multisampling: ") + apiName, { 800, 600 } } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Uniforms: ") + apiName, { 800, 600 }, JumaRE::TextureSamples::X2 } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
...
{
    if (!engine->init({ 
            { 1, JumaRE::WindowProperties{ JSTR("Mip maps: ") + apiName, { 800, 600 }, JumaRE::TextureSamples::X2 } }
        }))
    {
        JUTILS_LOG(error, JSTR("Failed to init render engine"));
        return;
